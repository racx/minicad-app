...
/* ---------- toggles ---------- */
// ortho starts OFF (as in AutoCAD): forced h/v on by default made free
// sketching feel like the cursor was being dragged away from the mouse
export const T = { grid:true, snap:false, ortho:false, osnap:true, dyn:true };
...
export let sugSel = 0;               // highlighted row in the command suggestions
export function setSugSel(i){ sugSel = i; }
