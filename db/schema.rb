...
ActiveRecord::Schema[8.1].define(version: 2026_08_26_195637) do
  ...
  create_table "drawings", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.jsonb "doc", default: {}, null: false
    t.integer "entity_count", default: 0, null: false
  ...
  create_table "editor_preferences", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.jsonb "prefs", default: {}, null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id"], name: "index_editor_preferences_on_user_id", unique: true
  end
  ...
  add_foreign_key "editor_preferences", "users"
end
